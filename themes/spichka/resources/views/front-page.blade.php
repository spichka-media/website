  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        ...
        <a href="{{ carbon_get_post_meta(get_the_ID(), 'front_donate_button_link') }}" target="_blank" class="btn btn-outline-light fs-5 fw-600 border-2 text-decoration-none">
      ...
      <div class="col">
        <div class="card h-100">
          <div class="card-body bg-dark text-white text-center px-4 py-5">
            ...
            <a class="btn btn-outline-light fs-5 fw-600 border-2 text-decoration-none" href="mailto:{{ carbon_get_theme_option('theme_email') }}"><i class="far fa-envelope"></i>
